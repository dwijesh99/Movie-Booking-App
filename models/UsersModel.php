...
class UsersModel extends Model
{
    ...
    public function register()
    {
        ...
        $sql = "INSERT INTO `" . $this->table . "`(`name`, `email`, `password`, mobile_number, verification_code, email_verified_at) VALUES ('$name', '$email', '$password', '$mobile_number', '" . $verification_code . "', NOW())";
