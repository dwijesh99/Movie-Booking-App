      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item nav-category"><span class="nav-link">Seasons</span></li>
            <li class="nav-item"> <a class="nav-link" href="<?= URL; ?>admin/seasons/all"> All Seasons </a></li>
            <li class="nav-item"> <a class="nav-link" href="<?= URL; ?>admin/seasons/add"> Add Season </a></li>
